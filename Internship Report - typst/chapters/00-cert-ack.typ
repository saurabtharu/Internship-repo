...
*“An Internship report on Software Engineer at Khalti Pvt. Ltd.”* for the fulfillment of the
...
the evaluation.
  ...
  #block(
    ...
    table(
      ...
      stroke: none,
      columns: (1fr, 0.3fr),
       [  #line(length: 15em,stroke: (thickness: 1pt, dash: ("dot",4pt))) *Mr. Pratik Timilsina* #v(-4pt) Supervisor #v(-4pt) Department of Computer Science and Information Technology #v(-4pt) Bhaktapur Multiple Campus #v(-4pt) Doodhpati, Bhaktapur ], [],
...
#text(12pt)[
  ...
  This is to certify that this internship report prepared by *Anukul Adhikari* entitled
*“An Internship report on Software Engineer at Khalti Pvt. Ltd”* has been submitted to the Department of Computer Science for
...
quality as a project for the required degree
  ...
  #table(
    ...
    [ *Signature of Mentor \ \ \ \ * #line(length: 12em,stroke: (thickness: 1pt, dash: ("dot",4pt))) *Er. Subit Raj Pokhrel* \  Khalti Pvt. Ltd ],

    
    // [*Signature of External Examiner *],[],
     [*Signature of HOD * \ \ \ \   #line(length: 12em,stroke: (thickness: 1pt, dash: ("dot",4pt))) *Mr. Sushant Paudel*   \ Bhaktapur Multiple Campus ], 
     [
...
Also, I would like to express my special gratitude to our Program Coordinator, *Mr. Sushant Paudel* and administrative staff whose all-time encouragement helped me coordinate the internship tasks systematically. 

I would like to express my sincere thanks to my mentors  *Er. Subit Raj Pokhrel* and *Er. Ashin Shakya* of Khalti Pvt. Ltd. for sharing their valuable knowledge and guiding me during the internship period, and making me learn new skills and abilities. I am also grateful to the entire staff of Khalti Pvt. Ltd for their constant support and guidance

With all due respect and gratitude, I would like to give a word of thanks to the members of the IT department of Bhaktapur Multiple Campus, who encouraged me to perform work
activities.
